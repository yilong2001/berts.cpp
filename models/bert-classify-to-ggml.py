...
model = BertForSequenceClassification.from_pretrained(dir_model, low_cpu_mem_usage=True)
print (model)
...
fout.write(struct.pack("i", model.config.num_labels))
fout.write(struct.pack("i", model.config.num_beams))
